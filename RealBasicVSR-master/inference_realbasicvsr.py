...
config = 'RealBasicVSR-master/configs/realbasicvsr_x4.py'
checkpoint = 'RealBasicVSR-master/checkpoints/RealBasicVSR_x4.pth'

def parse_args():
    parser = argparse.ArgumentParser(
        description='Inference script of RealBasicVSR')
    parser.add_argument('--input_dir', type=str, default='1', help='directory of the input video')
    parser.add_argument('--output_dir', type=str, default='1', help='directory of the output video')
    parser.add_argument(
        '--max_seq_len',
        type=int,
        default=3,
